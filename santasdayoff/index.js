...
Module['FS_createPath']("/res", "r", true, true);
   ...
   loadPackage({"files": [{"filename": "/res/textinput_key_shift.png", "start": 0, "end": 512, "audio": 0}, {"filename": "/res/letter.png", "start": 512, "end": 2793, "audio": 0}, {"filename": "/res/textinput_key_special.png", "start": 2793, "end": 3486, "audio": 0}, {"filename": "/res/textinput_key.png", "start": 3486, "end": 3756, "audio": 0}, {"filename": "/res/bag.png", "start": 3756, "end": 5477, "audio": 0}, {"filename": "/res/sound_falldown.wav", "start": 5477, "end": 74377, "audio": 1}, {"filename": "/res/sound_fired.wav", "start": 74377, "end": 190213, "audio": 1}, {"filename": "/res/music_christmas_tree.ogg", "start": 190213, "end": 1250278, "audio": 1}, {"filename": "/res/gifts.png", "start": 1250278, "end": 1254424, "audio": 0}, {"filename": "/res/santaometer.png", "start": 1254424, "end": 1255826, "audio": 0}, {"filename": "/res/bg.png", "start": 1255826, "end": 1261113, "audio": 0}, {"filename": "/res/play.png", "start": 1261113, "end": 1261827, "audio": 0}, {"filename": "/res/music_jingle_bells.ogg", "start": 1261827, "end": 1834764, "audio": 1}, {"filename": "/res/house.png", "start": 1834764, "end": 1841833, "audio": 0}, {"filename": "/res/textinput_key_space.png", "start": 1841833, "end": 1842173, "audio": 0}, {"filename": "/res/music_we_wish_you.ogg", "start": 1842173, "end": 2239197, "audio": 1}, {"filename": "/res/santa.png", "start": 2239197, "end": 2243417, "audio": 0}, {"filename": "/res/sound_tock.wav", "start": 2243417, "end": 2292387, "audio": 1}, {"filename": "/res/sound_boom.wav", "start": 2292387, "end": 2363703, "audio": 1}, {"filename": "/res/showscore_btns.png", "start": 2363703, "end": 2364365, "audio": 0}, {"filename": "/res/retry.png", "start": 2364365, "end": 2365076, "audio": 0}, {"filename": "/res/r/single.glsl", "start": 2365076, "end": 2366584, "audio": 0}, {"filename": "/res/r/someLICENSE", "start": 2366584, "end": 2367656, "audio": 0}, {"filename": "/res/r/singlerefract.glsl", "start": 2367656, "end": 2371233, "audio": 0}, {"filename": "/res/r/particlerefract.glsl", "start": 2371233, "end": 2376437, "audio": 0}, {"filename": "/res/r/batchrefract.glsl", "start": 2376437, "end": 2380185, "audio": 0}, {"filename": "/res/r/font85.png", "start": 2380185, "end": 2381237, "audio": 0}, {"filename": "/res/r/font55.png", "start": 2381237, "end": 2381770, "audio": 0}, {"filename": "/res/r/particle.glsl", "start": 2381770, "end": 2384904, "audio": 0}, {"filename": "/res/r/batch.glsl", "start": 2384904, "end": 2386583, "audio": 0}], "remote_package_size": 2386583, "package_uuid": "2803ea94-5795-4800-a014-412a73401b56"});
...
var ASM_CONSTS = {
  170236: function() {FS.mkdir('/savestate'); FS.mount(IDBFS, {}, '/savestate'); e_io_idbfs_synced = false;},  
 170322: function() {e_io_idbfs_synced = false; FS.syncfs(true, function (err) { assert(!err); e_io_idbfs_synced = true; });},  
 170426: function() {if(e_io_idbfs_synced) { ccall('e_io_idbfs_synced', 'v'); }},  
 170485: function() {e_io_idbfs_synced = false; FS.syncfs(false, function (err) { assert(!err); e_io_idbfs_synced = true; });},  
 170590: function() {if(e_io_idbfs_synced) { ccall('e_io_idbfs_synced', 'v'); }},  
 170649: function() {set_exit_failure_error_msg();},  
 170679: function() {set_error_img();},  
 170696: function() {set_exit_failure_error_msg();},  
 170726: function() {set_exit_failure_error_msg();},  
 170756: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 170981: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 172436: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 173425: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 173518: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 173587: function() {return screen.width;},  
 173612: function() {return screen.height;},  
 173638: function() {return window.innerWidth;},  
 173668: function() {return window.innerHeight;},  
 173699: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 173794: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 173931: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 174155: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 174648: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 174716: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 176368: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
