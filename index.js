...
Module['FS_createPath']("/res", "levels", true, true);
   ...
   loadPackage({"files": [{"filename": "/res/airstroke_naked.png", "start": 0, "end": 1749, "audio": 0}, {"filename": "/res/hare.png", "start": 1749, "end": 5473, "audio": 0}, {"filename": "/res/carrot_btn.png", "start": 5473, "end": 6127, "audio": 0}, {"filename": "/res/hud_background.png", "start": 6127, "end": 19655, "audio": 0}, {"filename": "/res/dead_overlay.png", "start": 19655, "end": 22463, "audio": 0}, {"filename": "/res/hare_dark.png", "start": 22463, "end": 25883, "audio": 0}, {"filename": "/res/carrot_mini.png", "start": 25883, "end": 26067, "audio": 0}, {"filename": "/res/carrot.png", "start": 26067, "end": 26669, "audio": 0}, {"filename": "/res/goal_flag.png", "start": 26669, "end": 28434, "audio": 0}, {"filename": "/res/flag.png", "start": 28434, "end": 29635, "audio": 0}, {"filename": "/res/airstroke.png", "start": 29635, "end": 31706, "audio": 0}, {"filename": "/res/hud_tiles.png", "start": 31706, "end": 32109, "audio": 0}, {"filename": "/res/butterfly.png", "start": 32109, "end": 32666, "audio": 0}, {"filename": "/res/carrot_big.png", "start": 32666, "end": 33262, "audio": 0}, {"filename": "/res/backgrounds/greenhills.png", "start": 33262, "end": 37986, "audio": 0}, {"filename": "/res/r/someLICENSE", "start": 37986, "end": 39058, "audio": 0}, {"filename": "/res/r/single.fsh", "start": 39058, "end": 39221, "audio": 0}, {"filename": "/res/r/batch.fsh", "start": 39221, "end": 39384, "audio": 0}, {"filename": "/res/r/particle.fsh", "start": 39384, "end": 39547, "audio": 0}, {"filename": "/res/r/single.vsh", "start": 39547, "end": 40277, "audio": 0}, {"filename": "/res/r/font55.png", "start": 40277, "end": 40865, "audio": 0}, {"filename": "/res/r/particle.vsh", "start": 40865, "end": 42999, "audio": 0}, {"filename": "/res/r/batch.vsh", "start": 42999, "end": 43873, "audio": 0}, {"filename": "/res/tiles/tile_01.png", "start": 43873, "end": 44657, "audio": 0}, {"filename": "/res/tiles/tile_02.png", "start": 44657, "end": 48827, "audio": 0}, {"filename": "/res/tiles/tile_03.png", "start": 48827, "end": 51237, "audio": 0}, {"filename": "/res/levels/level_01.png", "start": 51237, "end": 52632, "audio": 0}], "remote_package_size": 52632, "package_uuid": "e4e47a27-590c-4129-9415-bb3554e6f6fd"});
...
var ASM_CONSTS = {
  94900: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 96355: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 97344: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 97437: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 97506: function() {return screen.width;},  
 97531: function() {return screen.height;},  
 97557: function() {return window.innerWidth;},  
 97587: function() {return window.innerHeight;},  
 97618: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 97713: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 97850: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 98074: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 98567: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 98635: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
